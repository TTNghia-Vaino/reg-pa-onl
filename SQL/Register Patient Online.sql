...
CREATE TABLE TAI_KHOAN (
    MA_TK INT PRIMARY KEY AUTO_INCREMENT, -- Khóa chính
...
CREATE TABLE BENH_NHAN (
    ...
    MA_BHYT VARCHAR(15),                   -- Mã bảo hiểm y tế
...
CREATE TABLE QUAN_LY (
    MA_QL INT PRIMARY KEY AUTO_INCREMENT,   -- Khóa chính
    MA_TK INT,                              -- Khóa ngoại
...
CREATE TABLE TIN_TUC (
    MA_TIN_TUC INT PRIMARY KEY AUTO_INCREMENT, -- Khóa chính
...
CREATE TABLE DANG_KY_KHAM (
    MA_DK INT PRIMARY KEY AUTO_INCREMENT,     -- Khóa chính
